...
describe('Network Manager service', () => {
  ...
  it('should be online when is a webview and has connection', () => {
  ...
  it('should not be online when is a webview and has no connection', () => {
    ionic.Platform.isWebView = () => true;
    navigator.connection = { type: $window.Connection.NONE};
  ...
  it('should not be offline when is a webview and has connection', () => {
    ionic.Platform.isWebView = () => true;
    navigator.connection = { type: $window.Connection.CELL_2G};
  ...
  it('should be offline when is a webview and has no connection', () => {
    ionic.Platform.isWebView = () => true;
    navigator.connection = { type: $window.Connection.NONE};
